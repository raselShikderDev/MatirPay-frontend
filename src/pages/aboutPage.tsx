...
const AboutPage = ({
  ...
  description =
    "MatirWallet is a secure and inclusive digital wallet built for the people of Bangladesh. From sending money to friends and family, to withdrawing cash via agents, we make financial transactions simple, reliable, and accessible for everyone.",
  ...
  achievementsDescription =
    "With thousands of active users and agents, MatirWallet is transforming the way Bangladesh handles everyday transactions — one tap at a time.",
